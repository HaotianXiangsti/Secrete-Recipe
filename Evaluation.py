...
train_x_tensor, val_x_tensor, test_x_tensor, train_loader, train_target_tensor, val_loader, val_target_tensor, test_loader, test_target_tensor, _mean, _std = load_graphdata_channel_evaluation(
...
with torch.no_grad():
    ...
    for s in range(number_envs):
        ...
        for i, x in enumerate(train_loader):
            ...
            c = c.reshape(c.shape[0], c.shape[1], in_channels-1, -1)
